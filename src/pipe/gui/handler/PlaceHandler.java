...
public class PlaceHandler 
   ...
   public JPopupMenu getPopup(MouseEvent e) {
      ...
      if (CreateGui.getModel().isResPlace(((Place)myObject).getId())) {
      	JMenuItem menuItemRemMsg = new JMenuItem(new CalResPlaceAction(contentPane,(Place)myObject));
  	    menuItemRemMsg.setText("Cancel ResPlace");
  	    popup.insert(menuItemRemMsg, index ++);
  	  }else {
  		JMenuItem menuItemAddMsg = new JMenuItem(new SetResPlaceAction(contentPane,(Place)myObject));
  	    menuItemAddMsg.setText("Set ResPlace");
  	    popup.insert(menuItemAddMsg, index ++);
  	  }
