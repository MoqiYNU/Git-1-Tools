...
public class PrintUtils {
	...
	public static void printNet(ProNet proNet) {
		...
		System.out.println("ResPlaces: " + proNet.getResPlaces());
		
		System.out.println("Resources: " + proNet.getResources());
		...
		Map<String, List<String>> reqResMap = proNet.getReqResMap();
		for (Entry<String, List<String>> entry : reqResMap.entrySet()) {
			  System.out.println("Res = " + entry.getKey() + ", Trans = " + entry.getValue()); 
		}
		
		Map<String, Integer> resProperMap = proNet.getResProperMap();
		for (Entry<String, Integer> entry : resProperMap.entrySet()) {
			  System.out.println("Res = " + entry.getKey() + ", Prop = " + entry.getValue()); 
		}
